          ...
          <div className="col-span-2 flex flex-col gap-4 items-start justify-between">
            ...
            <div className="flex flex-col">
              <div className="">
                ...
                />
                <span className="text-white">Alysson Carvalho</span>
              </div>
          ...
          <div className="max-w-3xl text-white my-8 md:my-16 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row md:gap-8 p w-full px-10 py-8  rounded-3xl bg-beige-primary text-black">
              ...
              <div className="flex flex-col gap-2 justify-between w-full">
                <div className=" flex flex-col ">
                  <h3 className="text-sub-title font-bold">Alysson Carvalho</h3>
                  <p className=" text-sm opacity-90">{data.authorPostion}</p>
                </div>
                <p>Alysson Carvalho is a distinguished Solar Energy Specialist at the forefront of the renewable energy revolution. With a passion for sustainable technology and a commitment to addressing the global energy crisis, Leslie has dedicated her career to advancing the field of solar energy.</p>
                <LindkedlnFooter />
              </div>
            </div>
          </div>
